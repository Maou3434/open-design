...
export const zhCN: Dict = {
  ...
  "fileViewer.netlifyTokenGetLink": "获取 Netlify Token",
  "fileViewer.netlifyTokenPlaceholder": "粘贴你的 Netlify Token",
  "fileViewer.netlifyTokenReuseHint": "将使用已保存的 Token。输入新 Token 可替换。",
  "fileViewer.netlifyTokenRequired": "请先输入并保存 Netlify Token。",
  "fileViewer.netlifyPreviewOnly": "目前仅支持部署到预览环境。",
  "fileViewer.renderProvider": "Render",
  "fileViewer.railwayProvider": "Railway",
  "fileViewer.renderToken": "Render API 密钥",
  "fileViewer.renderTokenGetLink": "获取 Render API 密钥",
  "fileViewer.renderTokenPlaceholder": "粘贴你的 Render API 密钥",
  "fileViewer.renderTokenReuseHint": "将使用已保存的密钥。输入新密钥可替换。",
  "fileViewer.renderTokenRequired": "请先输入并保存 Render API 密钥。",
  "fileViewer.railwayToken": "Railway API 密钥",
  "fileViewer.railwayTokenGetLink": "获取 Railway API 密钥",
  "fileViewer.railwayTokenPlaceholder": "粘贴你的 Railway API 密钥",
  "fileViewer.railwayTokenReuseHint": "将使用已保存的密钥。输入新密钥可替换。",
  "fileViewer.railwayTokenRequired": "请先输入并保存 Railway API 密钥。",
  "fileViewer.githubPatToken": "GitHub PAT",
  "fileViewer.githubPatTokenGetLink": "获取 GitHub PAT",
  "fileViewer.githubPatTokenPlaceholder": "粘贴你的 GitHub PAT",
  "fileViewer.githubPatTokenReuseHint": "将使用已保存的 PAT。输入新 PAT 可替换。",
  "fileViewer.githubPatTokenRequired": "请先输入并保存 GitHub PAT。",
