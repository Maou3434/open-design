...
export const fa: Dict = {
  ...
  'fileViewer.renderProvider': 'Render',
  'fileViewer.railwayProvider': 'Railway',
  'fileViewer.netlifyToken': 'توکن Netlify',
  'fileViewer.netlifyTokenGetLink': 'دریافت توکن Netlify',
  'fileViewer.netlifyTokenPlaceholder': 'توکن Netlify خود را وارد کنید',
  'fileViewer.netlifyTokenReuseHint': 'از توکن ذخیره‌شده استفاده می‌شود. برای جایگزینی، توکن جدید وارد کنید.',
  'fileViewer.netlifyTokenRequired': 'ابتدا یک توکن Netlify وارد و ذخیره کنید.',
  'fileViewer.netlifyPreviewOnly': 'استقرارها فعلاً فقط پیش‌نمایش هستند.',
  'fileViewer.renderToken': 'کلید API ارائه‌دهنده Render',
  'fileViewer.renderTokenGetLink': 'دریافت کلید API ارائه‌دهنده Render',
  'fileViewer.renderTokenPlaceholder': 'کلید API ارائه‌دهنده Render خود را وارد کنید',
  'fileViewer.renderTokenReuseHint': 'از کلید ذخیره‌شده استفاده می‌شود. برای جایگزینی، کلید جدید وارد کنید.',
  'fileViewer.renderTokenRequired': 'ابتدا یک کلید API ارائه‌دهنده Render وارد و ذخیره کنید.',
  'fileViewer.railwayToken': 'توکن API ارائه‌دهنده Railway',
  'fileViewer.railwayTokenGetLink': 'دریافت توکن API ارائه‌دهنده Railway',
  'fileViewer.railwayTokenPlaceholder': 'توکن API ارائه‌دهنده Railway خود را وارد کنید',
  'fileViewer.railwayTokenReuseHint': 'از توکن ذخیره‌شده استفاده می‌شود. برای جایگزینی، توکن جدید وارد کنید.',
  'fileViewer.railwayTokenRequired': 'ابتدا یک توکن API ارائه‌دهنده Railway وارد و ذخیره کنید.',
  'fileViewer.githubPatToken': 'توکن دسترسی شخصی GitHub (PAT)',
  'fileViewer.githubPatTokenGetLink': 'دریافت GitHub PAT',
  'fileViewer.githubPatTokenPlaceholder': 'GitHub PAT خود را وارد کنید',
  'fileViewer.githubPatTokenReuseHint': 'از PAT ذخیره‌شده استفاده می‌شود. برای جایگزینی، PAT جدید وارد کنید.',
  'fileViewer.githubPatTokenRequired': 'ابتدا یک GitHub PAT وارد و ذخیره کنید.',
